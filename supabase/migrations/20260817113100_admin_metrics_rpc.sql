...
revoke all on function public.consume_one_time_generation(text, text) from public;
grant execute on function public.consume_one_time_generation(text, text) to authenticated;
