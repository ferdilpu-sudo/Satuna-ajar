    ...
    <div className="min-h-screen bg-[#F4F6F2] text-slate-700 flex antialiased font-sans">
      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        <main className="flex-1 p-4 sm:p-6 lg:p-8 max-w-[1500px] w-full mx-auto">
          ...
          {currentTab === 'create' && (
            <WizardForm onGenerateSubmit={handleGenerateSubmit} presetTemplateModel={presetTemplateModel} />
          )}
          ...
          {currentTab === 'template' && <TemplateView onUseTemplate={handleUseTemplate} />}
      ...
      {editingRPP && (
        <RPPEditorModal
          ...
          onSaveRPP={(updated) => {
            ...
            if (activeRPP?.id === updated.id) setActiveRPP(updated);
          }}
        />
      )}
    </div>
